...
const PAGES = [
  ...
  { key: 'blog-anthropic', path: '/blog/anthropic-modelle-schweiz', src: 'blog/anthropic-modelle-schweiz/index.html', out: 'blog/anthropic-modelle-schweiz/index.html', kind: 'static', ldText: true, lastmod: '2026-09-02', changefreq: 'monthly', priority: '0.7' },
  { key: 'blog-ch-daten', path: '/blog/ki-datenhaltung-schweiz', src: 'blog/ki-datenhaltung-schweiz/index.html', out: 'blog/ki-datenhaltung-schweiz/index.html', kind: 'static', ldText: true, lastmod: '2026-09-03', changefreq: 'monthly', priority: '0.7' },
  { key: 'blog-fristen', path: '/blog/ai-act-fristen-dezember-2026', src: 'blog/ai-act-fristen-dezember-2026/index.html', out: 'blog/ai-act-fristen-dezember-2026/index.html', kind: 'static', ldText: true, lastmod: '2026-09-03', changefreq: 'monthly', priority: '0.7' },
  { key: 'blog-agenten', path: '/blog/ki-agenten-governance', src: 'blog/ki-agenten-governance/index.html', out: 'blog/ki-agenten-governance/index.html', kind: 'static', ldText: true, lastmod: '2026-09-03', changefreq: 'monthly', priority: '0.7' },
  { key: 'blog-haftung', path: '/blog/ki-haftung-italien', src: 'blog/ki-haftung-italien/index.html', out: 'blog/ki-haftung-italien/index.html', kind: 'static', ldText: true, lastmod: '2026-09-03', changefreq: 'monthly', priority: '0.7' },
  { key: 'blog-quellen', path: '/blog/ki-quellen-statt-halluzination', src: 'blog/ki-quellen-statt-halluzination/index.html', out: 'blog/ki-quellen-statt-halluzination/index.html', kind: 'static', ldText: true, lastmod: '2026-09-03', changefreq: 'monthly', priority: '0.7' },
  { key: 'blog-memory', path: '/blog/ki-memory-wissensgraph', src: 'blog/ki-memory-wissensgraph/index.html', out: 'blog/ki-memory-wissensgraph/index.html', kind: 'static', ldText: true, lastmod: '2026-09-14', changefreq: 'monthly', priority: '0.7' },
