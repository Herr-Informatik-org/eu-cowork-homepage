...
export const LINKS = {
  de: {
    ...
    'preise': { titel: 'Preise', text: 'zwei Wege, ein Produkt. Selbstbetrieb dauerhaft gratis mit dem vollen Funktionsumfang inklusive aller Enterprise-Bausteine; die betreute Instanz kostet 7 Franken (7.50 Euro) pro Person und Monat, bis auf weiteres mit 50 Prozent Rabatt bei einer Laufzeit von zwölf Monaten, also 3.50 Franken (3.75 Euro). Der Modellverbrauch läuft über ein gemeinsames Guthaben der Organisation. Testen ist kostenlos und zeitlich unbefristet: jeder neue Zugang startet mit einem Startguthaben von 50 Franken (55 Euro), ohne Zahlungsdaten. Support für eigene Installationen separat buchbar.' },
    'blog': { titel: 'Blog', text: 'siebzehn Artikel für die Schweiz und Europa mit konkreten KI-Anwendungsfällen, Konnektoren zur Branchensoftware und Branchen-FAQ, dazu Notizen aus dem Betrieb.' },
    'blog-memory': { titel: 'Ein Gedächtnis, das dem Unternehmen gehört', text: 'graphbasiertes Memory auf der eigenen Instanz: Knoten, benannte Kanten, Gültigkeitszeitraum, Herkunft und Berechtigung an jedem Eintrag; belegte Lücken der bekannten Memory-Funktionen aus deren eigener Dokumentation (Copilot-Gedächtnis im persönlichen Exchange-Postfach, keine Aufbewahrungssteuerung, keine Audit-Einträge; Claude-Erinnerungen für Eigentümer nicht einsehbar); Schreibweg mit Vorschlag und Abgleich, Leseweg mit Ausschnitt statt Gesamtbestand; Grenzen offen benannt, darunter die Angriffsfläche eingepflanzter Erinnerungen und der gemessen kleine Vorteil der Graphform bei einfachen Einzelfaktenfragen.' },
    'blog-ch-daten': { titel: 'Der Bund zieht eine Linie durch seinen Datenbestand', text: 'EDÖB-Tätigkeitsbericht 2025/2026 zu kommerziellen Sprachmodellen als Datensicherheitsrisiko, privatim-Resolution mit kundeneigenen Schlüsseln, Selbstbetrieb als einziger Weg dorthin; offengelegt wird, dass im betreuten Betrieb die einzelne Anfrage über Amazon Bedrock an ein kommerzielles Modell geht und der CLOUD Act greift; Österreich mit NISG 2026.' },
    'blog-fristen': { titel: 'Der 2. Dezember 2026 und der 12. Januar 2027', text: 'zwei übersehene Fristen aus der geänderten KI-Verordnung (EU) 2026/1744 und dem Data Act; Anbieter- gegen Betreiberpflichten in Artikel 50 getrennt; Wechselentgelte nach Artikel 29, Ankündigungsfrist nach Artikel 25 Absatz 2 Buchstabe d; der OVHcloud-Fall in Ontario ist offen.' },
    'blog-agenten': { titel: 'Handelnde KI und wer die Werkzeuge kontrolliert', text: 'CNIL-Note zu agentischer KI vom 20.7.2026, MCP-Fassung 2026-07-28, Rechte pro Werkzeug und Audit-Log; SecNumCloud 19.6 Buchstabe a trifft den Sitz, Buchstabe c den Modellweg, deshalb erfüllt weder ein Schweizer Rechenzentrum noch der Weg über Amazon Bedrock Artikel 31 Loi SREN.' },
    'blog-haftung': { titel: 'Wenn menschliche Aufsicht zur Strafnorm wird', text: 'italienische Durchführungsdekrete vom 4.8.2026 mit Artikel 437-bis c.p. und Unternehmenshaftung nach d.lgs. 231/2001, Nichtigkeit rein automatisierter Kündigungen; zum Redaktionsschluss am 3.9.2026 nicht in der Gazzetta Ufficiale veröffentlicht und damit nicht in Kraft; ACN-Regelwerk verlangt EU-Metadaten.' },
    'blog-quellen': { titel: '48 erfundene Urteile', text: 'spanische Gerichtsentscheide 2026 zu erfundenen Fundstellen, AEPD-Ratgeber, Wissensbasen mit Fundstelle; Fundstellen verhindern Halluzinationen nicht, sie machen sie prüfbar, und der Engpass ist fehlendes Fachpersonal.' },
    'blog-anthropic': { titel: 'Claude Opus und Sonnet über Amazon Bedrock', text: 'Spitzenmodelle von Anthropic über Amazon Bedrock im AWS-Rechenzentrum Frankfurt; drei Abläufe (lange Ausschreibungen, Regelwerk gegen eigene Weisungen, Vorgänge über mehrere Systeme via MCP); Architektur mit Datenhaltung in der Schweiz; CLOUD Act offen benannt, In-Region für Claude in eu-central-2 nicht verfügbar.' },
    ...
    'self-hosting': { titel: 'Self-Hosting', text: 'Docker-Compose-Stack, Auto-TLS via Caddy, private Websuche via SearXNG. Die MIT-Lizenz folgt demnächst, kein Seat-Limit, ab 1 Nutzer.' },
    ...
    'vision': { titel: 'Vision', text: 'Warum wir Kisuno bauen: Europas Firmen KI-fähig machen, mit Open Source, Transparenz und Schulungen.' },
    'warteliste': { titel: 'Zugang anfragen', text: 'Formular für den Zugang zur betreuten Schweizer Instanz; die Zugänge werden wegen der hohen Nachfrage gestaffelt vergeben. Testen ist kostenlos und zeitlich unbefristet, jeder neue Zugang startet mit einem Startguthaben von 50 Franken (55 Euro).' },
