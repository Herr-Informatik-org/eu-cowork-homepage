...
Die Grössenordnung ist erheblich und gemessen. Eine Brücke zu einer grossen Produktfamilie bot ungefiltert 164 Werkzeuge an, das sind rund 96 000 Tokens pro Konversation. Auf die 21 Werkzeuge gefiltert, die der Anwendungsfall tatsächlich braucht, waren es noch rund 8 000 Tokens, also 92 Prozent weniger. Eine bewusst schmal gebaute Brücke mit 7 Werkzeugen liegt bei rund 2 000 Tokens.
