...
Die Freigaben in EU Cowork AI kommen **zusätzlich** dazu. Sie entscheiden, wer welche Instanz überhaupt zu sehen bekommt. Fällt eine Regel im Panel einmal aus, trägt immer noch die Rechtegrenze des Dienstkontos.
...
- **Server-Standard sofort auf verweigert.** Solange der Standard nicht auf verweigert steht, sehen alle Personen alle Instanzen und damit alles, was die Dienstkonten sehen.
...
Weil die Rechte der Person bereits die Grenze sind, brächte eine zusätzliche Rechteregel davor keinen Sicherheitsgewinn. Für einen solchen Konnektor gibt es deshalb keine Regeln pro Rolle, Gruppe oder Person; steuerbar ist nur, ob eine Rolle Konnektoren überhaupt benutzen darf. Wer den Konnektor gar nicht haben soll, wird über die Modell- und Agentenkonfiguration gesteuert.
</Aside>
...
Die persönlichen Zugriffstoken liegen verschlüsselt in der Datenbank Ihrer Instanz. Ziehen Sie auf einen neuen Server um, müssen die zugehörigen Schlüssel der alten Instanz übernommen werden. Geschieht das nicht, sind alle gespeicherten Verbindungen unbrauchbar, und **jede Person muss ihren Zugang einmal neu aufbauen**. Es gehen dabei keine Daten verloren, aber es ist ein Support-Fall pro Mitarbeitendem. Nehmen Sie den Punkt in Ihren Umzugsplan auf, siehe [Backup und Umzug](/docs/betrieb/backup-und-umzug).
</Aside>
