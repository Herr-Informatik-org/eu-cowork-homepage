...
export default defineConfig({
  ...
  integrations: [
    ...
    starlight({
      ...
      // Starlights Kopfbereich bleibt erhalten und erhält strukturierte Daten.
      // Die Wortmarke ergänzt den bestehenden Namen um ein hochgestelltes AI;
      // Logo, Schrift, Farben und Abstände bleiben im Starlight-Design.
      components: {
