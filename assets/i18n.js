...
(function () {
  ...
  var CHROME = {
    en: {
      ...
      'chrome.cta.waitlist': 'Get started',
      ...
      'chrome.footer.link.booking': 'Book a live demo',
      ...
      'chrome.footer.link.teaBreak': 'Tea break',
    ...
    fr: {
      ...
      'chrome.cta.waitlist': 'Commencer maintenant',
      ...
      'chrome.footer.link.booking': 'Réserver une démo',
      'chrome.footer.link.faq': 'FAQ',
      'chrome.footer.link.docs': 'Documentation',
      'chrome.footer.link.blog': 'Blog',
      ...
      'chrome.footer.link.teaBreak': 'Pause thé',
      'chrome.footer.link.security': 'Security & Trust',
    ...
    it: {
      ...
      'chrome.cta.waitlist': 'Iniziare ora',
      'chrome.crumb.home': 'Home',
      ...
      'chrome.footer.link.booking': 'Prenotare una demo',
      'chrome.footer.link.faq': 'FAQ',
      ...
      'chrome.footer.link.teaBreak': 'Pausa tè',
      'chrome.footer.link.security': 'Security & Trust',
    ...
    es: {
      ...
      'chrome.cta.waitlist': 'Empezar ahora',
      ...
      'chrome.footer.link.booking': 'Reservar una demo',
      'chrome.footer.link.faq': 'FAQ',
      ...
      'chrome.footer.link.teaBreak': 'Pausa para el té',
      'chrome.footer.link.security': 'Security & Trust',
